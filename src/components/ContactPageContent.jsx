...
import { Mail, Phone, MapPin, Send, MessageCircle, Calendar, Zap, User, Briefcase, MessageSquare, Plus } from 'lucide-react';

const ContactPageContent = ({ onOpenChat, isHomePageSection = false }) => {
  ...
  const headerIcon = isHomePageSection ? <Mail className="w-16 h-16 text-blue-500 mx-auto mb-6" /> : <MessageSquare className="w-20 h-20 text-blue-400 mx-auto mb-8" />;
            ...
            {inputFields.map(field => (
              <div key={field.name} className="relative">
                ...
                <Input
                  ...
                  className="w-full p-4 pl-12 bg-slate-700/50 border-slate-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 outline-none transition-shadow"
                />
              </div>
            ))}
           ...
           <div className="text-center mt-16">
             <Button 
              ...
              >
                ...
                Une question rapide ? Demandez à Nova !
              </Button>
          </div>
        )}
      </section>
